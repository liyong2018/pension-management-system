...
CREATE TABLE `organization` (
  ...
  `address_province` VARCHAR(100) COMMENT '地址（省）',
  `address_city` VARCHAR(100) COMMENT '地址（市）',
  `address_district` VARCHAR(100) COMMENT '地址（区）',
  `address_street` VARCHAR(255) COMMENT '地址（街道）',
  `address_detail` VARCHAR(255) COMMENT '地址（门牌号）',
